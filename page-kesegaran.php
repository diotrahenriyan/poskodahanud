       ...
       ?>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class='aktif'><a href="page-kesegaran.php">KESEGARAN JASMANI</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Data Kesegaran Jasmani</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                       <?php
                                            if(@$_SESSION['admin'])
                                            {
                                             $sql = "SELECT * FROM pers_data_personil INNER JOIN pers_samapta_org ON pers_data_personil.nrp=pers_samapta_org.nrp";
                                            }
                                            else{
                                                if(@$_SESSION['pussen'])
                                                {
                                                ...
                                                $sql = "SELECT * FROM pers_data_personil INNER JOIN pers_samapta_org ON pers_data_personil.nrp=pers_samapta_org.nrp WHERE pers_data_personil.tipe ='".$usertype."'";   
                                            }
