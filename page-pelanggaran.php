        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class='aktif'><a href="page-pelanggaran.php">PELANGGARAN</a></li>
                </ul>
                <!-- end side-menu -->
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                       <?php
                                            if(@$_SESSION['admin'])
                                            {
                                             $sql = "SELECT * FROM pers_data_personil INNER JOIN  pers_pelanggaran ON pers_data_personil.nrp= pers_pelanggaran.nrp";
                                            }
                                            else{
                                                if(@$_SESSION['pussen'])
                                                {
                                                ...
                                                $sql = "SELECT * FROM pers_data_personil INNER JOIN  pers_pelanggaran ON pers_data_personil.nrp= pers_pelanggaran.nrp WHERE pers_data_personil.tipe ='".$usertype."'";   
                                            }
